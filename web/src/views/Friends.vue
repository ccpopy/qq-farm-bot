...
function loadTabData() {
  ...
  if (activeTab.value === 'friends')
    void loadData()
  // The friend list also renders blocked badges; this list comes from local settings.
  if ((activeTab.value === 'friends' || activeTab.value === 'blacklist') && blacklistLoadedAccount.value !== accountId) {
    blacklistLoadedAccount.value = accountId
    void friendStore.fetchBlacklist(accountId)
  }
  if (activeTab.value === 'visitors' && currentAccountRunning.value && interactRecordsLoadedAccount.value !== accountId) {
