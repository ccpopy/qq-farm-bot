...
function createWorkerApiRegistry(context: WorkerApiContext): Map<string, WorkerApiDefinition> {
    ...
    register('getActivityDirectorySnapshot', ([traceId]) => activity.getActivityDirectorySnapshot(traceId));
    register('getActivityCenterSnapshot', ([traceId]) => activity.getActivityCenterSnapshot(null, traceId));
    ...
    register('claimCharityRedFlowerSeeds', ([traceId]) => activity.claimCharityRedFlowerSeeds(traceId));
    register('donateCharityRedFlowerLove', ([traceId]) => activity.donateCharityRedFlowerLove(traceId));
    register('claimCharityRedFlowerProgressReward', ([target, traceId]) => activity.claimCharityRedFlowerProgressReward(target, traceId));
    register('claimCharityRedFlowerDailyGift', ([traceId]) => activity.claimCharityRedFlowerDailyGift(traceId));
